...
### [x] Activity 3: Fix delete-before-write and mtime:0 hydration (Bug C)
...
#### [x] Task 3.1: Write failing unit tests for write-first-then-delete and real-mtime hydration
